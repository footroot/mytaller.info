...
function init() {
  ...
  //tl.fromTo(textAnimation.rotation, 4, {y:0}, 0, 0); //{y:Math.PI * 2, ease:Power1.easeInOut}
...
function createTextAnimation() {
  ...
  THREE.BAS.Utils.tessellateRepeat(geometry, 1.0, 2); //(geometry, 1.0, 2)
...
function TextAnimation(textGeometry) {
  ...
  var aAnimation = bufferGeometry.createAttribute('aAnimation', 2); //2
  var aEndPosition = bufferGeometry.createAttribute('aEndPosition', 3); //3
  var aAxisAngle = bufferGeometry.createAttribute('aAxisAngle', 4); //4
